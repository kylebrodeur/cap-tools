<!--
Draft only — NOT posted, NOT yet a PR. Fetched live from CapSoftware/Cap
main on 2026-07-31 and one new section inserted (see
upstream/workflows-mdx-addition.md for that section on its own plus the
recreation notes). Everything else below is unmodified upstream content,
kept verbatim so this file is a direct drop-in replacement for
apps/web/content/docs/agents/workflows.mdx when the PR is ready.
-->
---
